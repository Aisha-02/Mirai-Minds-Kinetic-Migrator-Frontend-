...
export function ExecuteCleaningButton({
  ...
  return (
    <button
      ...
      onClick={onExecute}
      className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-primary py-4 font-headline-sm text-headline-sm text-on-primary shadow-primary transition-all duration-300 hover:shadow-card-hover disabled:cursor-not-allowed disabled:opacity-50"
    >
