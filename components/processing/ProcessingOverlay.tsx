...
function ProcessingStepNode({ step }: ProcessingStepNodeProps) {
  if (step.state === "complete") {
    return (
      <div className="z-10 flex w-32 flex-col items-center gap-2">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary shadow-primary">
  ...
  if (step.state === "active") {
    return (
      <div className="z-10 flex w-32 flex-col items-center gap-2">
        <div className="animate-pulse-icon relative flex h-16 w-16 items-center justify-center rounded-full border-4 border-brand-blue bg-surface">
  ...
  return (
    <div className="z-10 flex w-32 flex-col items-center gap-2">
      <div className="relative flex h-16 w-16 items-center justify-center overflow-hidden rounded-full border-2 border-outline-variant bg-surface-container-high">
        <div className="absolute inset-0 animate-shimmer-icon bg-gradient-to-r from-transparent via-ink/10 to-transparent" />
        <Icon
          name={step.icon}
      ...
      <div className="text-center">
        <p className="font-headline-sm text-headline-sm font-bold text-on-surface-variant">
          {step.label}
        </p>
...
export function ProcessingOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/25 p-6 backdrop-blur-sm sm:p-12">
      <div className="flex w-full max-w-2xl flex-col items-center rounded-2xl border border-outline-variant bg-surface p-8 shadow-overlay">
        ...
        <p className="mb-8 animate-pulse text-center font-body-md text-body-md font-bold text-brand-blue">
          {statusText}{" "}
          <span className="ml-2 font-mono-data text-on-surface text-mono-data">
            {clampedProgress}%
          </span>
        </p>
        ...
        <div className="relative mb-4 flex w-full items-start justify-between px-4">
          <div className="absolute top-8 right-16 left-16 -z-10 h-1 rounded-full bg-outline-variant">
            <div
              className="h-1 rounded-full bg-brand-blue transition-all duration-500 ease-out"
